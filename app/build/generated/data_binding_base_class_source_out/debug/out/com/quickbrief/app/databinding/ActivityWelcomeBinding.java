...
public final class ActivityWelcomeBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton continueAsGuestButton;
  ...
  private ActivityWelcomeBinding(@NonNull LinearLayout rootView,
      @NonNull MaterialButton continueAsGuestButton, @NonNull MaterialButton loginButton,
  ...
  public static ActivityWelcomeBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.continueAsGuestButton;
      MaterialButton continueAsGuestButton = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityWelcomeBinding((LinearLayout) rootView, continueAsGuestButton, loginButton,
          signupButton);
    }
